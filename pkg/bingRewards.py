...
# get a set of queries from today's Bing! history
		...
		print ";" * 30
		print "bingRewards.__processSearch()"
		print "bfp: ", bfp
		print "bfp.Reward: ", bfp.Reward
		print "bfp.Type: ", bfp.Reward.Type
		print "bfp.Reward.Type.SEARCH_AND_EARN_DESCR_RE: ", bfp.Reward.Type.SEARCH_AND_EARN_DESCR_RE
		print ";" * 30
		sys.exit(0)
